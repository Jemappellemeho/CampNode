          ...
          steps={[
            {
              ...
              body: <p>Click a main node to open its resources and subtopics.</p>,
            },
            {
              number: 2,
              title: 'Syllabus',
              className: 'right-4 top-28 lg:right-16',
              body: <p>Open the syllabus to jump between nodes and review your progress.</p>,
            },
            {
              number: 3,
              title: 'Study Assistant',
              className: 'right-4 bottom-28 lg:right-20',
              body: <p>Use the chat button when you need help with this course.</p>,
            },
          ]}
        />
      )}
